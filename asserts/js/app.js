angular.module('authApp', ['ngResource', 'ngRoute', 'ui.bootstrap', 'angular-loading-bar', 'chart.js']).
    ...
    controller('authController', function($scope, api, $location) {
        ...
        tour.addStep('upload', {
          text: 'Нажмите на кнопку для загрузки чеков в приложение. Этот файл вам надо получить через приложение "Проверка чеков", которое можно скачать из AppStore или GooglePlay. Как пользоваться приложением: <a href="http://goo.gl/onxmi3" target="_blank">ссылка</a>',
